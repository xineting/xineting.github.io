...
* 下图所示，format的地址为0xffffce4c，是printf的第11个参数，即（0xffffce4c-0xffffce20）/4=11，由于flag的两个地址写在了format最开始的位置，因此它们分别是printf的第11和第12个参数。
  ...
  ![1541412207594](F:\xineting.github.io\img\1541412207594.png)
...
* 覆写内存 执行printf(format)前下断点
  ...
  ![1541412866964](F:\xineting.github.io\img\1541412866964.png)

  前两个为flag的地址

  后面的为字符串

  ![1541413028878](F:\xineting.github.io\img\1541413028878.png)

  在栈中查看

  ![1541413097707](F:\xineting.github.io\img\1541413097707.png)
